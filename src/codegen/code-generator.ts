...
// Generated by src/tools/build-bootstrap-bundle.ts at build time.
const nodeBootstrapCode = require('../runtime/node-bootstrap-bundle').default;
...
class CodeGenerator extends AstVisitor<SourceNode> {
  ...
  private bundle(compiledModuleSourceNode: SourceNode) {
    ...
    if (this.opts.enableBundling) {
      ...
      sourceNode.add(nodeBootstrapCode);
    } else {
      sourceNode.add(compiledModuleSourceNode);
